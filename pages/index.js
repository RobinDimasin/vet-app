  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage: `url("https://cdn.discordapp.com/attachments/880911305471586354/996796654604791808/ezgif.com-gif-maker_2.gif")`,
        }}
      >
        <div className="hero-overlay bg-opacity-60"></div>
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-md">
            <h1 className="mb-4 text-6xl font-bold drop-shadow-lg shadow-black">
              Welcome to Vetreatment!
            </h1>
        ...
        <div className="hero-content md:px-[5%]">
          <div className="text-center lg:text-start">
            ...
            <p className="py-6 pr-20 text-[#3b3b3b]">
              ...
              treatments, <br /> diagnoses, vaccinations, deworming, general
      ...
      <div className="hero h-auto pb-7">
        <div className="hero-content text-center">
          <div>
            <h1 className="text-5xl text-[#2a7a9f] font-bold pb-7">
              OUR SERVICES
            </h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="card h-64 w-64 bg-base-100 shadow-md rounded-xl mr-7 mb-7 border border-[#d9d9d9]">
                <figure className="px-10 pt-10">
                  <img src="/image/1.png" alt="Check-up" />
                </figure>
                <div className="card-body items-center text-center">
                  <h2 className="card-title text-[#2a7a9f] font-bold">
                    Check-up
                  </h2>
                </div>
              </div>

              <div className="card h-64 w-64 bg-base-100 shadow-2xl rounded-xl mr-7 mb-7">
                <figure className="px-10 pt-10">
              ...
              <div className="card h-64 w-644 bg-base-100 shadow-md rounded-xl mr-7 mb-7 border border-[#d9d9d9]">
                <figure className="px-10 pt-10">
              ...
              <div className="card h-64 w-64 bg-base-100 shadow-2xl rounded-xl">
                <figure className="px-10 pt-10">
              ...
              <div className="card h-64 w-64 bg-base-100 shadow-md rounded-xl border border-[#d9d9d9]">
                <figure className="px-10 pt-10">
      ...
      <div
        className="hero h-50 py-20"
        style={{
          backgroundImage: `url("https://www.houstonansweringservices.com/site/wp-content/uploads/2018/08/veterinarian.jpg")`,
        }}
      >
        <div className="hero-overlay bg-[#2a7a9f] opacity-60"></div>
        <div className="hero-content flex-col lg:flex-row-reverse">
          <img
            src="https://aurismedical.com/templates/yootheme/cache/spacer-7a3d6174.png"
            className="max-w-sm rounded-lg"
          />
          <div>
            <h1 className="text-5xl text-white font-bold">Join us!</h1>
            <p className="py-3 text-white">
              We believe in nurturing the human-animal bond and creating a
              harmonious relationship
              <br />
              between people and animals and we appreciate the role we get to
              play in your pets’ health
              <br />
              care. Register to become a part of our family!
            </p>
            <Link href={"/register"}>
              <button
                className="h-10 px-5 text-white font-bold transition-colors duration-150 bg-[#2a7a9f] 
      ...
      <footer className="footer p-10 bg-neutral text-neutral-content">
        <div>
          ...
          <p>
            ...
            <br />
            Providing the best services for your pets.
          </p>
        </div>
        <div>
