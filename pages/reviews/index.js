      ...
      <div className="px-[10%] mt-5 mb-5 grid grid-cols-3 gap-4">
        <div className="card bg-base-100 shadow-xl">
          ...
          <div className="card-body items-center">
            ...
            <p></p>
            <p className= "items-center text-center">Amazing services! My &#128054; is satisfied.</p>
          </div>
        ...
        <div className="card bg-base-100 shadow-xl">
          ...
          <div className="card-body items-center">
            ...
            <p className= "items-center text-center">
              The doctor is so good! My baby cat is so happy. &#128049;
            </p>
          </div>
        </div>
        ...
        <div className="card bg-base-100 shadow-xl">
          ...
          <div className="card-body items-center">
            ...
            <p className= "items-center text-center">
              {" "}
              The online appointment is so convenient. Did not wait in long
              queue.
            </p>
          </div>
