        ...
        <div className="px-[10%]">
            ...
            <div className="px-[10%] mt-5 mb-5 grid grid-cols-3 gap-4">
                <div class="card bg-base-100 shadow-xl">  
                  <div class="avatar justify-center mt-5">
                    ...
                    <p></p>
                    <p class="items-center text-center">Amazing services! My &#128054; is satisfied.</p>
          ...
          <div class="card bg-base-100 shadow-xl">  
            ...
            <div class="card-body items-center">
                ...
                <p></p>
                <p class="items-center text-center">The doctor is so good! My baby cat is so happy. &#128049;</p>
            </div>
          </div>
          ...
          <div class="card bg-base-100 shadow-xl">  
              ...
              <div class="card-body items-center">
                  ...
                  <p></p>
                  <p class="items-center text-center">I recommend this vet clinic. My pet appointment went smoothly.</p>
                </div> 
          </div>
              ...
              <div class="avatar justify-center mt-5">
                ...
                <div class="card-body items-center">
                  <h2 class="card-title text-center">Tristan A.</h2>
                    ...
                    <p></p>
                    <p class="items-center text-center">Great accomodation!</p>
                  </div>
          </div>
              ...
              <div class="avatar justify-center mt-5">
                ...
                <div class="card-body items-center">
                  <h2 class="card-title text-center">Tala Nicole V.</h2>
                    ...
                    <p></p>
                    <p class="items-center text-center">This vet clinic is worth it. Will come here again next time! &#128512; </p>
                </div>
          </div>
              ...
              <div class="avatar justify-center mt-5">
                ...
                <div class="card-body items-center">
                  <h2 class="card-title text-center">Nathaniel A.</h2>
                    ...
                    <p></p>
                    <p class="items-center text-center"> The online appointment is so convenient. Didn't wait in long queue.</p>
                </div>
          </div>
          </div>
      </>
